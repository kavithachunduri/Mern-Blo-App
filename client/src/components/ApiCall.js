...
const API_KEY = "563492ad6f917000010000017b9281f5eeea440da692b1ec885e8a5a"
    ...
    export async function popularWallPaper(){
        ...
        const response_popularWallPaper = await axios.get('https://api.pexels.com/v1/curated?per_page=28',
       {headers:{
    ...
    export async function searchWallPaper(search){
        ...
        const response_searchWallPaper = await axios.get(`${BASE_URL}/search?query=${search}&per_page=30`,
        {headers:{
            'Authorization': API_KEY
        }});
